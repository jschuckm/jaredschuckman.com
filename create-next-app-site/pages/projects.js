  ...
  return (
        <div class="App">
            ...
            <Container style={{display:"flex",justifyContent:"center",flexDirection: "column", marginTop:"5em",textAlign:"left"}}>
                <Row>
                    <Col>
                        <h2 style={{fontFamily:"Montserrat",fontWeight:"700",letterSpacing:"0px",fontSize:"x-large"}}><a style={{color:"black",}}href="https://github.com/jschuckm?tab=repositories">Github Profile<img style={{width:"30px",height:"30px"}} src="GitHub-Mark.png"></img></a></h2>
                        <h2 style={{fontFamily:"Montserrat",fontWeight:"700",letterSpacing:"0px",fontSize:"x-large"}}><a style={{color:"black"}} href="https://github.com/jschuckm/CowChips4Charity">CowChips4Charity Senior Design Project   <img style={{width:"30px",height:"30px"}} src="GitHub-Mark.png"></img></a></h2>
                        ...
                        <h2 style={{fontFamily:"Montserrat",fontWeight:"700",letterSpacing:"0px",fontSize:"x-large"}}><a style={{color:"black"}} href="https://github.com/jschuckm/EthereumTravelInsurance">Ethereum Travel Insurance Smart Contract<img style={{width:"30px",height:"30px"}} src="GitHub-Mark.png"></img></a></h2>
                        <p style={{fontFamily:"Montserrat",fontWeight:"300",letterSpacing:"0.02em",color:"#818181",fontSize:"22px",lineHeight:"30px",textAlign:"left"}}>
